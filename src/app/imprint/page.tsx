            ...
            <div>
              ...
              <div className="p-6 rounded-xl border border-grid-border bg-grid-surface/30 space-y-4 text-grid-text-dim leading-relaxed">
                <div>
                  ...
                  <p>[Stra&szlig;e und Hausnummer] &mdash; <span className="text-grid-amber text-xs font-mono">TODO: fill in after UG registration</span></p>
                ...
                <div>
                  ...
                  <p>[Name des Gr&uuml;nders] &mdash; <span className="text-grid-amber text-xs font-mono">TODO: fill in after UG registration</span></p>
                </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="p-6 rounded-xl border border-grid-border bg-grid-surface/30 space-y-4 text-grid-text-dim leading-relaxed">
                <div>
                  <p className="text-grid-text font-display font-bold">Grid Impulse UG (in Gr&uuml;ndung)</p>
                  <p>[Street address] &mdash; <span className="text-grid-amber text-xs font-mono">TODO: fill in after UG registration</span></p>
                ...
                <div>
                  ...
                  <p>[Founder name] &mdash; <span className="text-grid-amber text-xs font-mono">TODO: fill in after UG registration</span></p>
                </div>
